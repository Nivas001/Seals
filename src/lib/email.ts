    ...
    const htmlContent = `
      ...
      <html>
        ...
        <body style="margin: 0; padding: 20px; background-color: #f9f9f9;">
          <div style="font-family: 'Inter', -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; border: 1px solid #eaeaea; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 20px rgba(0, 0, 0, 0.03); background-color: #ffffff;">
            <!-- Header -->
